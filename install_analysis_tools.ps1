...
if (-not $SkipOffice) {
    ...
    # Note: For actual Office, you'd need to:
    # 1. Use Office Deployment Tool (ODT)
    # 2. Use Volume License or MAK key
    # 3. Create configuration.xml for silent install
}
...
# Flash Player is EOL but still useful for analyzing old malware
# Download from archive.org or use offline installer
